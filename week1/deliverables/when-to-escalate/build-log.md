...
| Q4 | Reasons for rows `0e`, `3`, `10`, `13`, `14`, `17`, `18`, `20`, `22`, `24`, `29` and `30` are still blank. `0c` is now filled. | Open | Fill in above. |
...
| Q10 | No synthetic case set exists yet in `data/`, so nothing has been run against a real LLM. | Open | Schema and archetypes settled (decisions 26–28). Expansion to 100 cases is the next step; still needs a run on KK's machine. |
