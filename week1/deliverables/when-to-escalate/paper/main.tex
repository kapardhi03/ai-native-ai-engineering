...
own readiness prior narrows the gap from 0.86 to 0.07, so we report the direction of
that result with more confidence than its magnitude. Against a policy that escalates
...
to 2.526 --- the gap narrows from 0.86 to 0.07. It also reverses the comparison
