...
Everything is under
[`week1/deliverables/when-to-escalate/`](week1/deliverables/when-to-escalate/).

| | |
| --- | --- |
| the policy, belief, and cost matrix | [`src/costs.py`](week1/deliverables/when-to-escalate/src/costs.py), [`src/belief.py`](week1/deliverables/when-to-escalate/src/belief.py) |
| the run every number above comes from | [`results/run.md`](week1/deliverables/when-to-escalate/results/run.md), [`results/run.json`](week1/deliverables/when-to-escalate/results/run.json) |
| the 16 misses, worked through | [`results/wrong-decisions.md`](week1/deliverables/when-to-escalate/results/wrong-decisions.md) |
| one decision reasoned out by hand | [`decisions/probability-decision-record.md`](week1/deliverables/when-to-escalate/decisions/probability-decision-record.md) |
| every design choice, and why | [`build-log.md`](week1/deliverables/when-to-escalate/build-log.md) |
| the paper | [`paper/main.tex`](week1/deliverables/when-to-escalate/paper/main.tex) |
